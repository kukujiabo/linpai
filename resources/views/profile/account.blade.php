...
<div class="sub-wrapper">
  ...
  <div class="box padding-20" id="passwd-modify">
    <div class="alert alert-success margin-5 hide"></div>
    <div class="alert alert-danger margin-5 hide"></div>
    <form class="form-inline" method="post" id="passwd-form"  action="/profile/passwd">
      <input type="hidden" name="_token" value="{{csrf_token()}}">
      <fieldset>
        <div class="form-group padding-5 width-100">
          <label class="control-label col-xs-3 text-right padding-top-5">旧密码：</label>
          <input class="form-control" name="oldpassword" type="password" title="旧密码">
        </div>
      </fieldset>
      <fieldset>
        <div class="form-group padding-5 width-100">
          <label class="control-label col-xs-3 text-right padding-top-5">新密码：</label>
          <input class="form-control" name="newpassword" type="password" title="新密码">
        </div>
      </fieldset>
      <fieldset>
        <div class="form-group padding-5 width-100">
          <label class="control-label col-xs-3 text-right padding-top-5">确认密码：</label>
          <input class="form-control col-xs-9" name="confirmpassword" type="password" title="确认密码">
        </div>
      </fieldset>
      <fieldset>
